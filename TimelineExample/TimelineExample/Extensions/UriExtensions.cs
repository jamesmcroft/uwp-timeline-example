namespace TimelineExample.Extensions
{
    ...
    /// <summary>
    /// Defines a collection of extensions for URLs.
    /// </summary>
    public static class UriExtensions
    {
        ...
        {
            List<KeyValuePair<string, string>> query = uri.ExtractQueryValues().ToList();

            KeyValuePair<string, string> item = query.FirstOrDefault(x => x.Key.Equals(key, StringComparison.OrdinalIgnoreCase));
